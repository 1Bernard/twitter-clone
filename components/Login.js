...
function Login({providers}) {
  return (
    <div className='flex flex-col items-center space-y-6 pt-48'>
      <Image
      ...
      <div>
         {Object.values(providers).map((provider) => (
          <div key={provider.name}>
            ...
            <button
              className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded border-2 border-blue-400 hover:bg-white group"
