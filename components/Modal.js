          ...
          <div className="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full">
            ...
            <div className="flex px-4 pt-5 pb-2.5 sm:px-6">
              <div className="w-full">
                <div className="text-[#050505] flex gap-x-3 relative">
                  ...
                  <div>
                    <div className="inline-block group">
                      <h4 className="font-bold text-[#050505] inline-block text-[15px] sm:text-base">
                        {post?.username}
                      </h4>
                    ...
                    <p className="text-[#050505] text-[15px] sm:text-base">
                      {post?.text}
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-7 flex space-x-3 w-full">
                  ...
                  <div className="flex-grow mt-2">
                    <textarea
                      ...
                      rows="2"
                      className="bg-transparent outline-none text-[#050505] text-lg placeholder-gray-500 tracking-wide w-full min-h-[80px]"
                    />
