...
function Sidebar() {
  ...
  return (
    <div className='hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full'>
        ...
        <Image src= 'https://cdn-icons-png.flaticon.com/128/733/733579.png' width={30} height={30} />
        </div>

        <div className='space-y-2 mt-3 mb-2.5 xl:ml-24'>
        ...
        <div className='text-[#000000f1] flex items-center justify-center hoverAnimation xl:ml-auto xl:-mr-5 mt-auto' onClick={signOut}>
